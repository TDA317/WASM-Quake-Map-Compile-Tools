...
void ExportNodePlanes(node_t *headnode); // This is defined in writebsp.c and used locally.
void BeginBSPFile(void); // This is defined in writebsp.c and used locally.
void FinishBSPFile(void); // This is defined in writebsp.c and used locally.
...
void LoadMapFile(void); // This is in map.c
